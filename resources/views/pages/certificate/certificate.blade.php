<x-main-card>
    ...
    <div class="flex flex-wrap justify-between">
        {{-- 
            <x-button-link value="STUDY CERTIFICATE"  />
            <x-button-link value="BONAFIED CERTIFICATE" />
            <x-button-link value="CASTE CERTIFICATE" />
            <x-button-link value="CHARACTER CERTIFICATE" />
            <x-button-link value="CHARACTER CERTIFICATE" />
            <x-button-link value="CERTIFICATE" /> 
        --}}
                            ...
                            <tr>
                                ...
                                <x-td>
                                    <form action="{{route('certificate.certify')}}" method="post">
                                        @csrf
                                        <input type="text" name="id" value="${res.id}" hidden>
                                        <x-button-primary value="certify" />
                                    </form>
                                </x-td>
                            </tr>
                                `
